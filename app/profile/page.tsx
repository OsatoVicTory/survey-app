...
export default function ProfileUser() {
    ...
    const fetchData = useCallback(async() => {
        ...
        try {
            ...
            const data = await fetchManySurveys(user._id);
    ...
    useEffect(() => {
        if(!user) return router.push(`/?back=/profile`);
        else fetchData();
    }, [user]);
                        ...
                        <nav className={`${styles.Home_nav} w-full flex justify-between items-center`}>
                            ...
                            {!surveys.loading && <div className={styles.Hn_search}>
                                <div className="w-full flex items-center">
                                    ...
                                    <input placeholder="Search in your survey" onChange={(e) => setSearch(e.target.value)} />
                                </div>
